...
namespace SkyCoreLib.Utils
{
    ...
    public static class NetClient
    {
        ...
        public static string GetIP(this HttpContext httpContext)
        {
            ...
            if (httpContext != null)
                result = httpContext.GetWebClientIp();
            if (result.IsEmpty())
                result = GetLanIp();
            return result;
        }
        ...
        /// 获取Web客户端的Ip
        /// </summary>
        private static string GetWebClientIp(this HttpContext httpContext)
        {
            var ip = httpContext.GetWebRemoteIP();
        ...
        /// 获取客户端IP
        /// </summary>
        private static string GetWebRemoteIP(this HttpContext httpContext)
        {
        ...
        {
            return httpContext == null ? Dns.GetHostName() : httpContext.GetWebClientHostName();
        }

        /// <summary>
        /// 获取Web客户端主机名
        /// </summary>
        private static string GetWebClientHostName(this HttpContext httpContext)
        {
        ...
        public static string GetLocation(string ip)
        {
            ...
            try
            {
                ...
                res = HttpRequester.HttpGet(url, Encoding.GetEncoding("GBK"));
