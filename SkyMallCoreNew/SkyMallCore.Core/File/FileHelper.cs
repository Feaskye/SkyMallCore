...
namespace SkyMallCore.Core
{
    public class FileHelper
    {
        ...
        public static string[] GetMapDirectories(string directoryPath)
        {
            try
            {
                return Directory.GetDirectories(MapPath(directoryPath));
            }
            catch (IOException ex)
            {
                throw ex;
        ...
        public static void CreateDir(string dir)
        {
            ...
            if (!Directory.Exists(AppRootPath + "\\" + dir))
                Directory.CreateDirectory(AppRootPath + "\\" + dir);
        }
        #endregion
        ...
        public static void DeleteDir(string dir)
        {
            if (dir.Length == 0) return;
            if (Directory.Exists(AppRootPath + "\\" + dir))
                Directory.Delete(AppRootPath + "\\" + dir);
        }
        #endregion
        ...
        {
            if (File.Exists(AppRootPath + file))
            {
                File.Delete(AppRootPath + file);
            }
        }
        #endregion
        ...
        public static void CreateFile(string dir, string pagestr)
        {
            ...
            StreamWriter sw = new StreamWriter(AppRootPath + "\\" + dir, false, System.Text.Encoding.GetEncoding("GB2312"));
            sw.Write(pagestr);
            sw.Close();
        }
        /// <summary>
        ...
        public static void MoveFile(string dir1, string dir2)
        {
            dir1 = dir1.Replace("/", "\\");
            dir2 = dir2.Replace("/", "\\");
            if (File.Exists(AppRootPath + "\\" + dir1))
                File.Move(AppRootPath + "\\" + dir1, AppRootPath + "\\" + dir2);
        }
        #endregion
        ...
        public static void CopyFile(string dir1, string dir2)
        {
            if (dir1.Contains("/"))
            {
                dir1 = AppRootPath + "\\" +dir1.Replace("/", "\\");
            }
            if (dir2.Contains("/"))
            {
                dir2 = AppRootPath + "\\" + dir2.Replace("/", "\\");
            }
            if (File.Exists(dir1))
            {
        ...
        //    if (File.Exists(AppRootPath + "\\" + dir1))
        //    {
        //        File.Copy(AppRootPath + "\\" + dir1, AppRootPath + "\\" + dir2, true);
        //    }
        //}
        ...
        /// <param name="isContainsExten">是否包含扩展名</param>
        /// <returns></returns>
        public static string GetFileName(string filePath,bool isContainsExten = true)
        {
            //获取文件的名称
        ...
        /// 本地路径
        /// </summary>
        /// <param name="path">单层文件夹/文件</param>
        /// <returns></returns>
        ...
        {
            return AppRootPath+ "\\" + relativePath.TrimStart('/').Replace("/","\\");
        }
        ...
        {
            return absolutePath.Replace(AppRootPath, "").Replace("\\",@"\");
        }
        ...
        /// <returns></returns>
        public static string RelativePath(string localPath)
        {
            return localPath.Replace(AppRootPath,"").Replace("\\","/");
        }
        public static bool IsExistMapFolder(string folder)
        {
        ...
        #region Base64 ot---to String

        //图片 转为    base64编码的文本
        public static string ImgToBase64String(string Imagefilename, ImageFormat imageFormat)
        {
            String strbaser64 = "";
        ...
        //base64编码的文本 转为    图片
        public static bool Base64StringToImage(string base64String,string txtFileName, ImageFormat imageFormat)
        {
            bool b= false;
            try
            {
                base64String = base64String.Trim().Replace("data:image/png;base64,","");
                byte[] arr = Convert.FromBase64String(base64String);
                MemoryStream ms = new MemoryStream(arr);
                Bitmap bmp = new Bitmap(ms);

                bmp.Save(txtFileName, imageFormat);
                //bmp.Save(txtFileName + ".bmp", ImageFormat.Bmp);
                //bmp.Save(txtFileName + ".gif", ImageFormat.Gif);ImageFormat.Jpeg
