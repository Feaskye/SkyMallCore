...
{
    public class MemberScoreRespository : AuditedRespository<MemberScore>, IMemberScoreRespository
    {
        public MemberScoreRespository(ISkyMallDbContext skyMallDbContext) : base(skyMallDbContext)
        {
        }
