...
{
    public class ArticleTopicRespository : AuditedRespository<ArticleTopic>, IArticleTopicRespository
    {
        public ArticleTopicRespository(ISkyMallDbContext skyMallDbContext) : base(skyMallDbContext)
        {
        }
