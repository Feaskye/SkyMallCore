...
{
    public class NewsRespository : AuditedRespository<News>, INewsRespository
    {
        INewsCategoryRespository _NewsCategoryRespository;
        public NewsRespository(ISkyMallDbContext skyMallDbContext,
            INewsCategoryRespository NewsCategoryRespository) : base(skyMallDbContext)
        {
