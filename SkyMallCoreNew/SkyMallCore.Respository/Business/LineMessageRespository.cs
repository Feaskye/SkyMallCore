...
{
    public class LineMessageRespository : AuditedRespository<LineMessage>, ILineMessageRespository
    {
        public LineMessageRespository(ISkyMallDbContext skyMallDbContext) : base(skyMallDbContext)
        {
        }
