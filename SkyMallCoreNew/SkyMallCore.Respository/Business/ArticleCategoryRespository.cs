...
{
    public class ArticleCategoryRespository : AuditedRespository<ArticleCategory>, IArticleCategoryRespository
    {
        public ArticleCategoryRespository(ISkyMallDbContext skyMallDbContext) : base(skyMallDbContext)
        {
        }
