...
namespace SkyCore.GlobalProvider
{
    ...
    public static class IOCContainer
    {
        ...
        /// 默认容器
        /// </summary>
        internal static readonly AufacContainer DefaultContainer = new AufacContainer();

        /// <summary>
        /// 创建容器
        /// </summary>
        /// <param name="configs">依赖配置</param>
        public static AufacContainer CreateContainer(params IModule[] configs)
        {
            var container = new AufacContainer();
